...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M1.5 3.375c0-1.036.84-1.875 1.875-1.875h17.25c1.035 0 1.875.84 1.875 1.875v10.5c0 1.035-.84 1.875-1.875 1.875h-3.435a.75.75 0 01-.442-.129L13.5 13.637V15.75c0 .414-.336.75-.75.75h-7.5a.75.75 0 01-.75-.75V3.375z" clipRule="evenodd" />
        <path d="M10.5 6.75a.75.75 0 00-1.5 0v4.5a.75.75 0 001.5 0v-4.5z" />
        <path d="M13.5 6.75a.75.75 0 00-1.5 0v4.5a.75.75 0 001.5 0v-4.5z" />
        <path fillRule="evenodd" d="M3.75 20.625c0-1.036.84-1.875 1.875-1.875h12.335a.75.75 0 01.442.129l2.863 2.147a.75.75 0 01-.884 1.258l-2.662-1.996a.75.75 0 00-.442-.129H9.75a.75.75 0 01-.75-.75v-2.25a.75.75 0 00-1.5 0v2.25c0 1.035.84 1.875 1.875 1.875h6.335a.75.75 0 01.442.129l2.662 1.996a.75.75 0 01-.884 1.258l-2.863-2.147a.75.75 0 00-.442-.129H5.625A3.375 3.375 0 012.25 18v-1.375c0-1.036.84-1.875 1.875-1.875h.375a.75.75 0 010 1.5H3.75z" clipRule="evenodd" />
    </svg>
);
